		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="缴费金额" prop="jiaofeijine">
							<el-input class="list_inp" v-model.number="form.jiaofeijine" placeholder="缴费金额"
								 type="number" 								:readonly="!isAdd||disabledForm.jiaofeijine?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jiaofeijine'){
					form.value.jiaofeijine = row[x];
					disabledForm.value.jiaofeijine = true;
					continue;
				}
				if(x=='beizhu'){
