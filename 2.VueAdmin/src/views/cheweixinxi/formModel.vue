		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="车位价格" prop="cheweijiage">
							<el-input class="list_inp" v-model.number="form.cheweijiage" placeholder="车位价格"
								 type="number" 								:readonly="!isAdd||disabledForm.cheweijiage?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="车位详情" prop="cheweixiangqing">
							<el-input v-model="form.cheweixiangqing" placeholder="车位详情" type="textarea"
							:readonly="!isAdd||disabledForm.cheweixiangqing?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='cheweijiage'){
					form.value.cheweijiage = row[x];
					disabledForm.value.cheweijiage = true;
					continue;
				}
				if(x=='cheweixiangqing'){
					form.value.cheweixiangqing = row[x];
					disabledForm.value.cheweixiangqing = true;
					continue;
				}
				if(x=='storeupnum'){
