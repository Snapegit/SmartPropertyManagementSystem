		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="房屋朝向" prop="fangwuchaoxiang">
							<el-input class="list_inp" v-model="form.fangwuchaoxiang" placeholder="房屋朝向"
								 type="text" 								:readonly="!isAdd||disabledForm.fangwuchaoxiang?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fangwuchaoxiang'){
					form.value.fangwuchaoxiang = row[x];
					disabledForm.value.fangwuchaoxiang = true;
					continue;
				}
				if(x=='loudong'){
